...
function $4f8e5fb2dc7a6f8f$export$8d92423c30b5888a() {
    var s = [];
...
class $5bbdaa7df4002674$var$SimpleImageLabel {
    ...
    resizeImage() {
        const setImg = ()=>{
            ...
            if (this.imageLabelAreaEl.clientWidth >= width) imageContent.style.width = (0, $4f8e5fb2dc7a6f8f$export$42dea53aa0f06782)(width / this.imageLabelAreaEl.clientWidth);
    ...
    initLabelElement() {
        ...
        this.labels.forEach((label)=>{
            // 初始化uuid
            if (!label.uuid) label.uuid = (0, $4f8e5fb2dc7a6f8f$export$8d92423c30b5888a)();
    ...
    mousedown(e) {
        ...
        if (isResizeDot) {
            ...
            this.labelItemTemp = (0, $4f8e5fb2dc7a6f8f$export$b7d58db314e0ac27)(this.labelItem);
            this.endPoint = {
        ...
        if (!this.startPointTemp) this.startPointTemp = (0, $4f8e5fb2dc7a6f8f$export$b7d58db314e0ac27)(this.startPoint);
        // 设置labelItem
        this.labelItem.uuid = (0, $4f8e5fb2dc7a6f8f$export$8d92423c30b5888a)();
        this.labelItem.x = x;
        this.labelItem.y = y;
    ...
    mouseup(e) {
        ...
        if ((0, $4f8e5fb2dc7a6f8f$export$248d38f6296296c5)(this.startPoint, this.endPoint) || this.labelItem.width === 0 && this.labelItem.height === 0) this.removeLabelByUuid(this.labelItem.uuid);
        // 重置
        this.labelItem = {};
        this.isMouseDown = false;
    ...
    changeLabelSize(labelItem, endPoint) {
        ...
        if (!this.resizeDotName) {
            ...
            if (this.resizeDotName.includes("e")) label.style.width = (0, $4f8e5fb2dc7a6f8f$export$42dea53aa0f06782)(x <= 0 ? endPoint.x : endPoint.x - x);
        }
        const attr = {
